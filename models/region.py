...
class InnovingRegion(models.Model):
    _name = "innoving.region"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Gestion des regions"
    _order = "name asc"
    ...
    cluster_id = fields.Many2one("innoving.cluster",string="Cluster",track_visibility="always")
    #departement_ids = fields.Many2many('innoving.departement','region_departement_rel','region_id','departement_id','Départements')
    departement_ids = fields.One2many('innoving.departement','region_id',string="Départements")
