...
class InnovingCommune(models.Model):
    _name = "innoving.commune"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Gestion des communes"
    _order = "name asc"
    ...
    #localite_ids = fields.Many2many('innoving.localite','commune_localite_rel','commune_id','localite_id','Régions')
    localite_ids = fields.One2many('innoving.localite','commune_id',string='Localité')
