...
class InnovingSousPrefecture(models.Model):
    _name = "innoving.sous.prefecture"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Gestion des sous prefectures"
    _order = "name asc"
    ...
    #commune_ids = fields.Many2many('innoving.commune','sousprefecture_commune_rel','sousprefecture_id','commune_id','Communes')
    commune_ids = fields.One2many('innoving.commune','sousprefecture_id',string="Sous préfecture")
