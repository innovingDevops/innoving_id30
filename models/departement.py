...
class InnovingDepartement(models.Model):
    _name = "innoving.departement"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Gestion des departements"
    _order = "name asc"
    ...
    #sousprefecture_ids = fields.Many2many('innoving.sous.prefecture','departement_sousprefecture_rel','departement_id','sousprefecture_id','Sous Préfectures')
    sousprefecture_ids = fields.One2many('innoving.sous.prefecture','departement_id','Sous Préfectures')
