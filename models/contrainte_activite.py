...
class InnovingContrainteActivite(models.Model):
    _name = "innoving.contrainte.activite"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Gestion des contraintes"
    _order = "name asc"
    ...
    name = fields.Char(string="Contrainte", track_visibility="always")
    ...
    valeur = fields.Char(string="valeur", track_visibility="always")
    #region_ids = fields.Many2many('innoving.region','cluster_region_rel','cluster_id','region_id','Régions')
